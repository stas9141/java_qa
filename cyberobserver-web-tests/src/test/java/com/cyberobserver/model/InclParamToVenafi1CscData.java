...
public class InclParamToVenafi1CscData {
    ...
    public InclParamToVenafi1CscData(String installation, String validto, String dnname, String status, String approver, String name,
